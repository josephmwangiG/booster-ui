<template>
  <div class="mt-2">
    <el-form
      ...
      label-position="top"
    >
      <div class="lg:flex gap-3" v-if="action === 'create'">
        <el-form-item label="Create For" prop="create_client">
          <el-radio-group v-model="formData.create_client">
            <el-radio :value="false">Existing Client</el-radio>
            <el-radio :value="true">New Client</el-radio>
          </el-radio-group>
        </el-form-item>
      </div>
      <div class="lg:flex gap-3">
        <el-form-item
          prop="water_client_id"
          class="flex-1"
          :label="'Client'"
          v-if="!formData.create_client"
        >
          <el-select
          ...
          >
            ...
            >
              ...
              <span
                ...
                "
              >
                <span class="font-semibold">{{ item.phone }}</span>
              </span>
            </el-option>
          </el-select>
        </el-form-item>
      </div>
      <div class="lg:flex gap-3" v-if="formData.create_client">
      ...
      <div class="lg:flex gap-3">
        <el-form-item
          prop="quantity_liters"
          class="flex-1"
          :label="'Delivery Capacity (Liters)'"
        >
          <el-input
            v-model="formData.quantity_liters"
            type="number"
        ...
        >
          ...
          >
            <el-option
              ...
              :key="vehicle.id"
              :label="`${vehicle.plate_number} - ${vehicle.brand || 'N/A'} ${
                vehicle.model || 'N/A'
              }`"
              :value="vehicle.id"
            />
      ...
      <el-checkbox
        v-model="formData.record_payment"
