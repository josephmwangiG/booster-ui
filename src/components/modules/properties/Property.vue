        ...
        <div class="grid grid-cols-3 mt-3 gap-6">
          <div class="border border-dashed p-3 px-4 rounded">
            <h2 class="font-semibold">
              {{ store.property?.units.length.toLocaleString() }}
            </h2>
        ...
        <div class="flex justify-between align-center">
          <div class="">
            ...
            <span class="text-gray-400 text-sm">
              {{ store.property?.units.length }} units
            </span>
          </div>
          <button @click="addItem" class="btn-primary my-auto">Add Unit</button>
        </div>
        <div class="overflow-x-auto w-full">
          <table class="w-full" ref="dataTableRef">
            <thead class="t-head">
              <tr>
                <th class="t-th">Unit Code</th>
            ...
            <tbody class="divide-y divide-gray-100">
              ...
              >
                ...
                <td class="t-td">
                  {{
                    item?.tenancies?.length > 0
                      ? item?.tenancies[0]?.tenant?.tenant_name
                      : "-"
                  }}
                </td>
