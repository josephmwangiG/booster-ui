    ...
    <div class="">
      <div class="w-full bg-white p-3 lg:p-6 mt-3 lg:mt-6">
        ...
        <div class="grid grid-cols-3 mt-3 gap-6">
          <div class="border border-dashed p-3 px-4 rounded col-span-1">
            <h2 class="font-semibold">{{ store.tenants.length.toLocaleString() }}</h2>
            <span class="text-gray-400 text-sm">Tenants</span>
          </div>
      ...
      <div class="space-y-6 p-3 lg:p-6 mt-3 lg:mt-6 bg-white col-span-3">
        <div class="flex justify-between align-center">
          <div class="">
            <h4 class="font-semibold">Tenants</h4>
            <span class="text-gray-400 text-sm"> {{ store.tenants.length }} items found </span>
          </div>
        ...
        <div class="overflow-x-auto w-full">
          <table class="w-full" ref="dataTableRef">
            ...
            <tbody class="divide-y divide-gray-100">
              <tr v-for="(item, index) in store.tenants" :key="index" :class="index % 2 != 0 ? 'bg-gray-50' : ''">
