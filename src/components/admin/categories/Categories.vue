        ...
        <div class="title">
          ...
          <span class="text-gray-500 text-sm">
            ...
            <span class="font-semibold text-gray-700">
              {{ store?.categories?.length?.toLocaleString() || 0 }}
            </span>
            categories
          </span>
        </div>
      ...
      <div class="overflow-x-auto w-full">
        <table ref="dataTableRef" class="w-full border-collapse text-sm">
          <thead class="bg-gradient-to-r from-blue-50 to-indigo-50">
            <tr>
              <th class="t-th text-left">Category Name</th>
            ...
            >
              ...
              <td class="t-td text-center">
                <div class="flex justify-center space-x-2">
                  <button @click="editCategory(item)" class="bg-blue-100 text-blue-700 hover:bg-blue-200 text-xs px-3 py-1 rounded-lg shadow-sm transition duration-300">
                    Edit
                  </button>
                  <button @click="deleteCategory(item.id)" class="bg-red-100 text-red-700 hover:bg-red-200 text-xs px-3 py-1 rounded-lg shadow-sm transition duration-300">
                    Delete
                  </button>
                </div>
              </td>
